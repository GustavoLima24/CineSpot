const contentData = {
    ATeoriaDeTudo: {
        videoSrc: 'https://www.youtube-nocookie.com/embed/SbUVNHdPE4w?si=2t6j6lMxhi5nwUHs',
    ...
    GeraçãoDoFuturo: {
        videoSrc: 'https://www.youtube-nocookie.com/embed/f22VA3aiyLE?si=KjMA_GYnWvRMmZJs',
        texto: 'Geração Do Futuro',
        ano: '2020',
        idade: '16+',
        temporadas: '',
        sinopse: 'Geração do Futuro é uma ficção científica dirigida por Sophie Barthes, ambientada em um futuro próximo onde a IA está na moda e a natureza está se tornando uma memória distante. Na trama Rachel (Emilia Clarke) e Alvy (Chiwetel Ejiofor) são um casal de Nova York pronto para levar seu relacionamento para o próximo nível e começar uma família. Para isso, eles decidem usar uma nova ferramenta desenvolvida por uma gigante da tecnologia.'
    },
    JovemSheldon: {
        videoSrc: 'https://www.youtube-nocookie.com/embed/-Si4OskjlKc?si=4FHwIIE1aa1xUhN4',
        texto: 'Jovem Sheldon',
        ano: '2017',
        idade: '12+',
        temporadas: '5 Temporadas',
        sinopse: 'Em Young Sheldon, spin-off de The Big Bang Theory, a trama acompanha o jovem Sheldon Cooper (Iain Armitage), de 9 anos, quando ele pula quatro séries para começar o ensino médio junto com seu irmão mais velho, menos intelectual. Enquanto ele luta para ser compreendido por sua família, colegas e vizinhos, sua mãe o oferece a melhor ferramenta que pode inventar: lembrar aos valentões que seu pai é o treinador de futebol e que seu irmão está no time. Sua irmã gêmea não compartilha sua mente excepcional, mas ela tem uma visão muito mais clara do que a vida reserva para o jovem gênio.'
    },
    LaCasaDePapel: {
        videoSrc: 'https://www.youtube-nocookie.com/embed/iS5xXr-GOnM?si=bG7OG30_nrz_PRp_',
        texto: 'La Casa De Papel',
        ano: '2017',
        idade: '16+',
        temporadas: '5 Temporadas',
        sinopse: 'Na série La Casa de Papel, da Netflix, nove habilidosos ladrões (Nairóbi, Berlim, Tókyo, Rio, Helsinki, Oslo, Professor, Denver e Moscou) se trancam na Casa da Moeda da Espanha, com o ambicioso plano de realizar o maior roubo da história. Possuindo a meta de imprimir 2,4 bilhões de euros, a gangue precisará lidar com as dezenas de pessoas que foram mantidas reféns e com os agentes da força de elite da polícia, que farão de tudo para que a investida dos criminosos fracasse. No processo, novos conflitos passam a surgir, precisando o grupo se preocupar, além dos problemas com a força policial, com os problemas entre eles próprios, que passam a ameaçar a natureza da missão. O elenco é composto por Álvaro Morte, Úrsula Corberó, Itzar Ituño, Pedro Alonso, Alba Flores, Miguel Herrán, Jaime Lorente, Esther Acebo e outros.'
    },
    Lucifer: {
        videoSrc: 'https://www.youtube-nocookie.com/embed/X4bF_quwNtw?si=1xVOQGEwBfEA77mZ',
        texto: 'Lucifer',
        ano: '2016',
        idade: '16+',
        temporadas: '6 Temporadas',
    ...
    Annabelle: {
        ...
        idade: '16+',
        temporadas: '',
        sinopse: 'Uma boneca demoníaca atormenta uma família, trazendo caos e medo com sua presença maligna.'
    }
};

function changeContent(key) {
    const data = contentData[key];
    document.getElementById('videoSrc').src = data.videoSrc;
    ...
    document.getElementById('temporadas').innerText = data.temporadas;
